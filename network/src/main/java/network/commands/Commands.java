...
/** Interface for network.commands.commands*/
public interface Commands {
    @network.Command(name = "help", desc = "справка по доступным коммандам")
    public default void help(String[] args) {
        ...
        for (Method method : Commands.class.getDeclaredMethods()) {
            ...
            if (method.isAnnotationPresent(network.Command.class)) {
                network.Command cmd = method.getAnnotation(network.Command.class);
    ...
    @network.Command(name = "info", desc = "вывести в стандартный поток вывода информацию " +
    ...
    @network.Command(name = "add", numbArgs = 1, args = "{element}",
    ...
    @network.Command(name = "update", numbArgs = 2, args = "id, {element}",
    ...
    @network.Command(name = "remove_by_id", numbArgs = 1, args = "id",
    ...
    @network.Command(name = "clear", desc = "очистить коллекцию")
    public void clear(String[] args) throws IOException, SQLException, ClassNotFoundException;

    @network.Command(name = "save", desc = "сохранить коллекцию в файл")
    public void save(String[] args) throws IOException;

    @network.Command(name = "execute_script", numbArgs = 1, args = "file_name",
    ...
    @network.Command(name = "exit", desc = "завершить программу " +
    ...
    @network.Command(name = "remove_head",
    ...
    @network.Command(name = "add_if_min", numbArgs = 1, args = "{element}",
    ...
    @network.Command(name = "remove_greater", numbArgs = 1, args = "{element}",
    ...
    @network.Command(name = "remove_any_by_height", numbArgs = 1, args = "height",
    ...
    @network.Command(name = "average_of_height",
